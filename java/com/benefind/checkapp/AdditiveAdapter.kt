...
class AdditiveAdapter(private var items: MutableList<Additive>) : RecyclerView.Adapter<AdditiveAdapter.AdditiveViewHolder>() {
    ...
    override fun onBindViewHolder(holder: AdditiveViewHolder, position: Int) {
        ...
        val color = when (additive.code) {
            "E-100", "E-101" -> Color.parseColor("#3fb500")
